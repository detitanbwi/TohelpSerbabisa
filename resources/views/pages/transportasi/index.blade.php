                    ...
                    <div class="col-md-8 col-lg-6">
                        <div class="card border-0 shadow-sm rounded-4 p-3" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <button type="button" class="btn btn-outline-primary rounded-pill px-3 py-1 btn-sm fw-semibold shadow-sm" data-bs-toggle="modal" data-bs-target="#modalPilihLokasi">
...
${paymentText}`
            ...
            @if(!($hasSelectedCabang ?? false))
                const modalEl = document.getElementById('modalPilihLokasi');
                if (modalEl && !sessionStorage.getItem('tohelp_cabang_selected')) {
    ...
    @if(isset($cabang) && $cabang->count() > 0)
        <div class="modal fade" id="modalPilihLokasi" tabindex="-1" aria-labelledby="modalPilihLokasiLabel" aria-hidden="true" {{ !($hasSelectedCabang ?? false) ? 'data-bs-backdrop=static data-bs-keyboard=false' : '' }}>
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                    <div class="modal-header border-0 pb-0 pt-4 px-4">
                        <div>
                            <h5 class="modal-title fw-bold text-dark fs-4" id="modalPilihLokasiLabel">
