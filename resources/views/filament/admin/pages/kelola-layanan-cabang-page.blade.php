    ...
    <div class="space-y-6">
        ...
        <x-filament::section>
            ...
            <div class="mt-3 text-xs text-gray-500 dark:text-gray-400">
                💡 <strong>Petunjuk:</strong> Klik salah satu nama layanan di bawah untuk membuka daftar sub-layanan. Atur ketersediaan centang atau masukkan tarif khusus untuk <strong>Cabang {{ $this->selectedCabangNama }}</strong>, lalu tekan tombol <strong>Simpan Pengaturan</strong> di bagian paling bawah.
            </div>
        </x-filament::section>
